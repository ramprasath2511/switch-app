...
import 'package:fiberchat/utils/widgets/PassCode/circle.dart';
import 'package:fiberchat/utils/widgets/PassCode/keyboard.dart';
import 'package:fiberchat/utils/widgets/PassCode/shake_curve.dart';
                ...
                ? FlatButton(
                    onPressed: () {
                      if (forgetActionable()) {
                        ...
                        Fiberchat.toast('Try again later.');
                    },
                    child: Padding(
